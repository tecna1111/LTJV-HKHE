...
const ROLE_NAV = {
  ...
  LECTURER: [
    ...
    ['Đánh giá chéo', ClipboardCheck, '/evaluations/summary'], ['Lịch họp', Video],
  ],
  STUDENT: [
    ['Tổng quan', LayoutDashboard], ['Lớp học của tôi', BookOpen], ['Workspace nhóm', FolderKanban],
    ['Đánh giá chéo', ClipboardCheck, '/peer-evaluations'], ['Tài nguyên', GraduationCap], ['Tin nhắn', MessageSquare],
  ],
};
