...
export default function ModuleLayout({ title, description, children }) {
  ...
  return <main className="dm-shell"><aside><BrandLogo /><nav aria-label="Chức năng">
    ...
    {role === 'LECTURER' && <NavLink to="/evaluations/summary">Tổng hợp đánh giá chéo</NavLink>}
    {role === 'STUDENT' && <NavLink to="/peer-evaluations">Đánh giá chéo</NavLink>}
    <details className="dm-support" open><summary>Đánh giá &amp; hỗ trợ</summary>
    {role === 'LECTURER' && <NavLink to="/evaluations/criteria">Quản lý tiêu chí</NavLink>}
